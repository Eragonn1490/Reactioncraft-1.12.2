...
public class WorldGenUndergroundStructureTemplates extends WorldGenerator 
{
	...
	public boolean generate(World world, Random rand, BlockPos position) 
	{
		...
		switch (j) 
		{
			case 1:  template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(constants.MODID + ":desert_treasure_1"));
				//Logger.info("1");
				break;
				
			
			default: template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(constants.MODID + ":desert_treasure_1"));
				//Logger.info("Default");
				break;
		}
		...
		if(WorldGenStructures.canSpawnHere(template, worldserver, position))
		{
			...
			template.addBlocksToWorld(world, position.add(0, -15, 0), placementsettings);
