...
public class ItemRegistry
{
    ...
    public static void init(IForgeRegistry<Item> forgeRegistry)
    {
        ...
        ItemIndex.wirelessTransmitter = (ItemTriggerRemote) register(new ItemTriggerRemote().setCreativeTab(Reactioncraft.ReactioncraftItems), forgeRegistry);
        ItemIndex.zeroizer            = (ItemTriggerClear)  register(new ItemTriggerClear() .setCreativeTab(Reactioncraft.ReactioncraftItems), forgeRegistry);
