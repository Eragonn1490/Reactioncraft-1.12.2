...
public class BlockExtendedPiston extends BlockPistonBase
{
    ...
    public BlockExtendedPiston(boolean isSticky)
    {
        super(isSticky);
    ...
    public boolean eventReceived(IBlockState state, World worldIn, BlockPos pos, int id, int param)
    {
        ...
        else if (id == 1)
        {
            ...
            //  
            worldIn.setBlockState(pos.offset(enumfacing, 1), Blocks.PISTON_EXTENSION.getDefaultState().withProperty(BlockPistonMoving.FACING, enumfacing).withProperty(BlockPistonMoving.TYPE, this.isSticky ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT), 3);
            worldIn.setTileEntity(pos.offset(enumfacing, 1), BlockPistonMoving.createTilePiston(this.getStateFromMeta(param), enumfacing, false, true));
