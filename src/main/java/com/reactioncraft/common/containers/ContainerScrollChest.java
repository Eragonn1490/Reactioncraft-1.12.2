...
public class ContainerScrollChest extends Container
{
    private final IInventory lowerChestInventory;
    private final int numRows;

    public ContainerScrollChest(IInventory playerInventory, IInventory chestInventory, EntityPlayer player)
    {
