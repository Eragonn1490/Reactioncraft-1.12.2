...
import com.reactioncraft.common.world.village.VillageCornField;
...
public class Villagers {
	...
	public static void registerVillageComponents() 
	{
		...
		MapGenStructureIO.registerStructureComponent(VillageCornField.class, constants.MODID + ":Field");
	}
}