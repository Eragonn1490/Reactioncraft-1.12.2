...
import com.reactioncraft.blocks.enums.EnumColumnTypes;
...
{
	public static final PropertyEnum<EnumColumnTypes> TYPE = PropertyEnum.create("type", EnumColumnTypes.class);
	public BlockColumn(Material material)
	{
		super(material);
		this.setCreativeTab(Reactioncraft.Reactioncraft);
		this.setDefaultState(this.blockState.getBaseState().withProperty(TYPE, EnumColumnTypes.BROWN1));
	}
...
//	}
	...
	public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
		for (EnumColumnTypes types : EnumColumnTypes.values())
		{
	...
	public IBlockState getStateFromMeta(int meta) {
		return getDefaultState().withProperty(TYPE,EnumColumnTypes.values()[meta]);
	}
